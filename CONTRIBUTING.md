# Contributing to Alphanumerics

Thank you for considering contributing to Alphanumerics! 🎉  
...
1. Navigate to the [Alphanumerics repository](https://github.com/MFM-347/Alphanumerics).
...
```bash
git clone https://github.com/<your-username>/Alphanumerics.git
cd Alphanumerics
```
...
Then, navigate to the **original Alphanumerics repository** and submit a pull request.  
...
Encountered a bug or have a great idea for a new feature? Create an issue [here](https://github.com/MFM-347/Alphanumerics/issues).
...
- Start a [discussion](https://github.com/MFM-347/Alphanumerics/discussions).
- Join our community for support and collaboration.

Thank you ✨ for contributing to Alphanumerics! Your effort makes this project better for everyone.
